...
export default function MoneyIcon() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
    ...
    return (
        <svg className='w-5' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 100.355 100.352" xmlSpace="preserve">
        <g>
            <path fill='white' d="M41.346,48.366c-7.64,0-13.855,6.214-13.855,13.852S33.706,76.07,41.346,76.07c7.636,0,13.849-6.214,13.849-13.852
            ...
            <path fill='white' d="M12.21,48.366c-0.829,0-1.5,0.671-1.5,1.5V74.57c0,0.829,0.671,1.5,1.5,1.5s1.5-0.671,1.5-1.5V49.866
                C13.71,49.038,13.039,48.366,12.21,48.366z"/>
            <path fill='white' d="M70.008,48.366c-0.829,0-1.5,0.671-1.5,1.5V74.57c0,0.829,0.671,1.5,1.5,1.5s1.5-0.671,1.5-1.5V49.866
                C71.508,49.038,70.836,48.366,70.008,48.366z"/>
            <path fill='white' d="M94.459,22.328h-72.85c-0.829,0-1.5,0.671-1.5,1.5v7.348H13.45c-0.829,0-1.5,0.671-1.5,1.5v8.172H4.586
