  ...
  return (
    <div id='home' className='h-screen bg-[url(/img/hero_image.jpg)] bg-cover bg-center'>
        <div className='bg-primary dark:bg-black dark:bg-opacity-75 bg-opacity-75 w-full h-full flex gap-4 flex-col justify-center items-center text-white'>
            ...
            <Link href='https://docs.google.com/forms/d/e/1FAIpQLScFm02odtuL2TSL3M0S6i2B8RuAtTQ99u88f-sp-T2RxRetSQ/viewform?usp=sharing' className='font-bold m-2 px-4 py-2 bg-secondary text-black rounded-full hover:bg-white hover:ring-secondary hover:ring-2'>Get Started <span aria-hidden="true">&rarr;</span></Link>
